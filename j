...
if ku.Notification.PrintMode == true then
    print("[ku]: is loading..")
    wait(3)
    print("[ku]: have successfully bypassed Anti Cheat..")
    wait(2)
    print("[ku]: Loading Functions..")
    wait(3.5)
    print(" [ku]: Has been successfully loaded, Enjoy your gameplay.")
end
--//bypass
...
local ku = getgenv().ku
if ku.Notification.SilentMode == true then
    ku.Notification.PrintMode = false
    ku.Notification.NotificationMode = false
    ku.Intro.ClearRConsole = true
    ku.Intro.Enabled = false
...
if game:IsLoaded() and ku.Intro.Enabled == true then
...
if ku.VisualEffects.AspectRatio == true then

end

if ku.VisualEffects.ColorCorrection == true then

local l = game:GetService("Lighting")

local ColorCorrection = Instance.new("ColorCorrectionEffect", l)
ColorCorrection.Brightness = ku.VisualEffects.ColorCorrectionBrightness
ColorCorrection.Contrast = ku.VisualEffects.ColorCorrectionContrast
ColorCorrection.Saturation = ku.VisualEffects.ColorCorrectionSaturation 
end
...
if ku.Intro.LowerGraphics then
...
if ku.Intro.ClearRConsole == true then
rconsoleclear()
end
